          ...
          <div class="box">
            <div class="box-header">
              <a class="logo" href="<?php echo base_url('assets/images/logo-pln.png') ?>"></a>
                ...
                <div class="body">
                  ...
                  <div class="col-md-8" >
                    <center>
                      <h4><b>DATA LIMBAH B3 PADA TEMPAT PENYIMPANAN SEMENTARA</b></h4>
                      UNIT&nbsp; &nbsp; &nbsp; &nbsp;: <br/>
              ...
              <h3 class="box-title">
                <a type="button" class="btn btn-block btn-success" href="<?php echo base_url('user/tambah/') ?>">Tambah Data</a>
                <a type="button" class="btn btn-block btn-primary" href="<?php echo base_url('user/export/') ?>">Export Data</a>
              </h3>
            </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">  
                ...
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $l->id_limbah ?></td>
                  <td><?php echo $l->jenis_limbah ?></td>
                  <td><img src="<?php echo base_url() . 'assets/images/'.$l->id.'.jpg'  ?>" class="img-thumbnail" alt="Foto Limbah" width="304" height="236"/></td>
                  <td><?php echo $l->jumlah ?></td>
                  <td><?php echo $l->masa_berlaku ?></td>
                  <td><?php echo $l->sumber ?></td>
                  <td><?php echo $l->tgl_masuk ?></td>
                  <td><?php echo $l->tgl_keluar ?></td>
                  <td><?php echo $l->keterangan ?></td>
                  <td>
                    <a class="btn btn-block btn-warning" href="<?php echo base_url('user/edit/'.$l->id) ?>">Edit</a>
                    <a class="btn btn-block btn-danger" href="<?php echo base_url('user/hapus/'.$l->id) ?>" >Hapus</a>
                    <a class="btn btn-block btn-info" href="<?php echo base_url('user/upload/'.$l->id) ?>">Upload</a>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
